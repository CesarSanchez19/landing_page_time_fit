<template>
    ...
    <!-- <section class="info-txt-img-contnt-main">
        ...
        <div class="info-txt-img-contnt">
            <img src="../assets/img-aboutUs/img-team-about-1.jpg" alt="Time Fit members">
            <div>
                <h2>Who are we?</h2>
        ...
        <div class="info-txt-img-contnt">
            <img src="../assets/img-aboutUs/img-vision-about-2.png" alt="Trainer talking to a client">
            <div>
                <h2>Vision</h2>
        ...
        <div class="info-txt-img-contnt">
            <img src="../assets/img-aboutUs/img-mission-about-3.png" alt="People in the Gym">
            <div>
                <h2>Mission</h2>
